 ...
 * @param ipInfoPath IPInfo database for IP lookups, this database contains a combination of ASN and
 *     country code. The free IPinfo lite dataset is more accurate than MaxMind Geoliteand only one
